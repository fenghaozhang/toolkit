...
def printHeader():
    ss = ["""// This file is generated with script, do not edit it directly!
// Please edit closure.py if needed.
//

#ifndef _SRC_BASE_CLOSURE_H_
#define _SRC_BASE_CLOSURE_H_
...
def printTail():
    print '} // namespace stone'
    print ''
    print '#endif // _SRC_BASE_CLOSURE_H_'
